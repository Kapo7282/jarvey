...
type TagColor = 'blue' | 'green' | 'red' | 'yellow' | 'purple';
...
export default function ChatPage({ params }: ChatPageProps) {
  ...
  const initialTags = [
    { id: 'active-subscriber', text: 'Active Subscriber', color: 'blue' as TagColor },
    { id: 'ai-responded', text: 'AI Responded', color: 'green' as TagColor },
    { id: 'high-priority', text: 'High Priority', color: 'red' as TagColor }
  ] as Tag[];
